...
<h2 style="background-color: #555;text-align: center; font-family: Avant Garde, Avantgarde, Century Gothic, CenturyGothic, AppleGothic, sans-serif;
        font-size: 3.5rem;
        padding: 4rem 4rem;
        text-align: center;
        ...
        >Hi 👋, My name is Arturo Velasquez</h2>
